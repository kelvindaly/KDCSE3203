...
CREATE TABLE `users` (
  ...
  `role` enum('manager','delivery_staff','warehouse_staff','customer') COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (6,'2024_07_27_220911_create_packages_table',3);
